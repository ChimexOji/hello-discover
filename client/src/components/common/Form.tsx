...
Stack, Select, MenuItem, Button } from '@pankod/refine-mui';

import { FormProps } from 'interfaces/common';
import CustomButton from './CustomButton';

const Form = ({ type, register, handleSubmit, handleImageChange, formLoading, onFinishHandler, // props from createproperty component
   ...
   <Box>
    ...
    <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="fcfcfc">
      <form style={{ marginTop: '20px', width: '100%', display: 'flex', flexDirection: 'column', gap: '20px' }} onSubmit={handleSubmit(onFinishHandler)}>
        {/* controls form component */}
        <FormControl>
          <FormHelperText sx={{ fontWeight: 500, margin: '10px 0', fontSize: 16, color: "#11142d"}}>Enter Property Name</FormHelperText>
          <TextField
          // material ui style properties
            fullWidth
            required
            id="outlined-basic"
            color="info"
            variant="outlined"
            {...register('title', {required: true})}    // register collects form details for passing to server or backend
          />
        </FormControl>
        ...
        {/* form control for select property type */}
        ...
        {/* form control for property location */}
        <FormControl>
          ...
          {/* form control for property photo */}
