  ...
  return (
    ...
    >
      ...
      />
       ...
       {/* component for card title and location properties */}
      <CardContent sx={{ display: 'flex', flexDirection: 'row', gap: '10px', paddingX: '5px', justifyContent: 'space-between' }}>
        ...
        {/* component for card price properties */}
