...
import { useGetIdentity } from '@pankod/refine-core';   // refine core hook to get id of user
    ...
    >
      ...
      <Stack direction="column" justifyContent="space-between" flex={1} gap={{xs: 4, sm:2}}>
        <Stack gap={2} direction="row" flexWrap="wrap" alignItems="center">
          <Typography fontSize={32} fontWeight={600} color="#11142d">{name}</Typography>
